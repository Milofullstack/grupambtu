  ...
  return (
    <>
      ...
      <SectionSplit
        ...
        align="left"
      >
          <h2 className="pt-20 text-2xl md:text-4xl lg:text-6xl text-center md:text-left font-philosopher text-shadow-lg  text-white mb-6">
            Grup Ambtu
          </h2>
          <p className="pt-10 text-lg md:text-2xl lg:text-3xl text-white font-medium leading-relaxed text-shadow-lg text-center md:text-left font-garamond text-pretty ">
      ...
      <SectionSplit title="Compromiso Social" imageId="DSC08354_a54uba" align="right">
        <EdgeReveal>
          ...
          <EdgeReveal>
          <p className="text-lg md:text-2xl lg:text-3xl pt-10 text-white text-center md:text-left leading-relaxed text-shadow-lg font-garamond text-pretty">
      ...
      >
        <EdgeReveal>
          ...
          <EdgeReveal>
          <p className=" pt-10 text-lg md:text-2xl lg:text-3xl text-white text-center md:text-left leading-relaxed text-shadow-lg font-garamond text-pretty">
