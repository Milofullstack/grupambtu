  ...
  return (
    <>
      ...
      <SectionSplit
        ...
        align="left"
      >
          <h2 className="pt-20 text-4xl lg:text-6xl text-center md:text-left font-philosopher text-shadow-lg  text-white mb-6">
            Grup Ambtu
          </h2>
          <p className="pt-10 text-2xl lg:text-3xl text-white font-medium leading-relaxed text-shadow-lg text-center md:text-left font-garamond text-pretty ">
      ...
      <SectionSplit title="Compromiso Social" imageId="DSC08354_a54uba" align="right">
        <EdgeReveal>
          <h2 className="text-4xl lg:text-6xl text-center md:text-left font-philosopher leading-relaxed text-shadow-lg text-white mb-6">
            Compromiso Social
          </h2>
          </EdgeReveal>
          <EdgeReveal>
          <p className="text-2xl lg:text-3xl pt-10 text-white text-center md:text-left leading-relaxed text-shadow-lg font-garamond text-pretty">
            Nuestro trabajo se fundamenta en criterios transparentes, evaluación justa y responsabilidad ética. Este compromiso se refleja en hechos: Grup Ambtu ha sido reconocido públicamente con el Premio a la Responsabilidad Social y Ética Empresarial otorgado por PIMEM en 2025, un reconocimiento a su labor en defensa de los residentes y su postura clara—“viviendas para los residentes, hoteles para los turistas”. La empresa actúa con responsabilidad, utilizando datos reales como las más de 9.100 personas inscritas en listas de demanda de vivienda en Baleares para orientar sus decisiones y priorizar proyectos donde más se necesitan.
          </p>
        </EdgeReveal>
      </SectionSplit>
      ...
      >
        <EdgeReveal>
          ...
          <EdgeReveal>
          <p className=" pt-10 text-2xl lg:text-3xl text-white text-center md:text-left leading-relaxed text-shadow-lg font-garamond text-pretty">
