      ...
      <div className="w-full h-full flex items-center justify-start">
        <div className="max-w-5xl w-full mx-auto px-8 md:px-24 flex items-center justify-start">
          <div className="w-full flex flex-col gap-8 md:gap-10 2xl:gap-20 justify-between text-center">
            <EdgeReveal>
              <h2 className="text-[#f5f5f5] mt-16 lg:mt-0 text-3xl md:text-7xl font-[font--philosopher] font-medium text-shadow-lg">
                Viviendas de Precio Limitado
              </h2>
            </EdgeReveal>

            <EdgeReveal>
              <p className="mt-4 text-lg md:text-2xl lg:text-3xl text-[#f5f5f5] font-medium font-[font--garamond] text-shadow-lg leading-relaxed">
                En GrupAmbtu impulsamos proyectos que combinan viabilidad,
                innovación y compromiso social. Fuimos pioneros en  <span className="font-bold">la primera
                promoción de Viviendas de Protección Limitada en Mallorca,</span> un
